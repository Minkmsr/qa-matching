...
<script src="<?php echo e(asset('assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js')); ?>"></script>
<script src="<?php echo e(asset('assets/data/jvector/visitor-data.js')); ?>"></script>
<!-- END: Page Vendor JS-->
...
<?php /**PATH C:\xampp\htdocs\qa\resources\views/layouts/app_footer.blade.php ENDPATH**/ ?>