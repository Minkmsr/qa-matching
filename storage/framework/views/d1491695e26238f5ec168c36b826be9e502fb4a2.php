                            ...
                            <div class="card-body">
                                ...
                                <?php echo csrf_field(); ?>
                                    <input type="hidden" class="form-control" name="task_id"
                                                    value="<?php echo e($result_task->task_id); ?>" id="task_id">
...
<?php echo $__env->make('layouts.app_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qa\resources\views/tasks/edit.blade.php ENDPATH**/ ?>